...
if menu == "Dashboard Overview":
    ...
    if conn:
        try:
            ...
            st.info("Database initializing or empty. Seed data will appear when backend starts.")
    ...
    if conn:
        ...
        st.info("Demo Mode: Backend database non-existent. Run FastAPI server to populate.")
