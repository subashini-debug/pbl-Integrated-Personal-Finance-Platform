...
export const api = {
  ...
  getGoals: () => request("/api/investments/goals"),
  createGoal: (payload) =>
    request("/api/investments/goals", { method: "POST", body: JSON.stringify(payload) }),
  deleteGoal: (id) => request(`/api/investments/goals/${id}`, { method: "DELETE" }),
